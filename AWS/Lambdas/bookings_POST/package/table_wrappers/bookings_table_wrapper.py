...
from package.models.bookings_model import Booking
from package.exceptions.bookings_exceptions import BookingOverlapException, BookingNotFoundException
...
class BookingsTable:
    ...
    def get_table(self):
        if not self.table is None:
            ...
            return self.table.create_table("bookings")

    def add_booking(self, booking: Booking):
        if self.table is None:
            logger.error("Table {} not created",
                         "bookings")
            raise Exception("Create table '{}' first".format("bookings"))
