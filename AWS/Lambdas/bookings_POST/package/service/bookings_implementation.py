...
import utilities.exceptions.bookings_exceptions as booking_exceptions
# FEHLT
# from currency_converter.client import CurrencyConverterClient, get_currency_converter_client_instance
from utilities.models.currencies import Currency
...
def create_booking(booking: BookingCreate, db: Session):
    # MM20250426: replace this line with lambda call to GET cars/{id}
